...
function DialogTrigger({
  ...
  return <DialogPrimitive.Trigger data-slot="dialog-trigger" className="mb-10 cursor-pointer" {...props} />
}
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Close
        className="ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground text-white absolute top-4 right-4 rounded-xs opacity-70 hover:opacity-100 hover:ring-2 hover:ring-offset-2 transition-all focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4">
        <XIcon />

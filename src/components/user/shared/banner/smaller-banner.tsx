...
const SmallerBanner = ({
  ...
  return (
    <section className="relative overflow-hidden">
      <motion.div
        className={cn(
          "w-full h-[150px] relative bg-cover bg-center",
          className
        )}
        style={{
      ...
      <div
        className={cn(
          "flex w-full justify-center text-center items-center text-white absolute bottom-2",
          divClass
        )}>
        <p className={cn("text-9xl font-black", textClass)}>{label}</p>
      </div>
    </section>
  );
};

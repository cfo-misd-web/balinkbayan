    ...
    return (
        <section className="relative">
            ...
            <motion.div
                ...
                style={{
                    backgroundImage: `linear-gradient(to right, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.2)), url('https://balinkbayan.gov.ph/wp-content/uploads/2020/12/books-college-cover-1845614.jpg')`,
                }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
